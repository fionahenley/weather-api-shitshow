...
$('#fetch-button').on('click', function() {
  ...
  var requestUrl = 'https://api.openweathermap.org/data/2.5/forecast?q=' + city + '&units=imperial&appid=fa57fae1d4c98167f0f54cf7a0c37d24';
...
//day three
  ...
  $("#icon3").html("<img src='https://openweathermap.org/img/w/" + data.list[10].weather[0].icon + ".png' alt='Icon weather.'>");
...
//day four
  ...
  $("#icon4").html("<img src='https://openweathermap.org/img/w/" + data.list[18].weather[0].icon + ".png' alt='Icon weather.'>");
...
//day five
  ...
  $("#icon5").html("<img src='https://openweathermap.org/img/w/" + data.list[26].weather[0].icon + ".png' alt='Icon weather.'>");
  ...
  $("#icon6").html("<img src='https://openweathermap.org/img/w/" + data.list[34].weather[0].icon + ".png' alt='Icon weather.'>");
